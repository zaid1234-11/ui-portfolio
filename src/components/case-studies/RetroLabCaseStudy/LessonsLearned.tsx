...
export default function LessonsLearned() {
  return (
    <section className="py-12 my-12 bg-white border border-black/10 rounded-2xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
        <ul className="space-y-6">
          <li className="flex gap-4">
            ...
            <p className="text-[#1c1c1b]/80 text-sm leading-relaxed">
