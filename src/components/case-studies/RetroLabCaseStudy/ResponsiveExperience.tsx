    ...
    <section className="py-12 relative">
      ...
      <div className="flex flex-col md:flex-row justify-center items-end gap-8 mt-16 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="w-28 h-56 border-[4px] border-white/20 rounded-2xl bg-[#0d1418] relative overflow-hidden group hover:border-[#E34A53]/50 transition-colors">
            <div className="absolute top-2 left-1/2 -translate-x-1/2 w-8 h-1 bg-white/20 rounded-full"></div>
            <div className="absolute inset-x-2 top-6 bottom-2 border border-white/10 rounded overflow-hidden">
          ...
          <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-[#FAF6EE]/70">
        ...
        <div className="flex flex-col items-center gap-4 hidden sm:flex">
          <div className="w-56 h-72 border-[4px] border-white/20 rounded-2xl bg-[#0d1418] relative overflow-hidden group hover:border-[#E34A53]/50 transition-colors">
            <div className="absolute top-2 left-1/2 -translate-x-1/2 w-1 h-1 bg-white/20 rounded-full"></div>
            <div className="absolute inset-x-2 top-6 bottom-2 border border-white/10 rounded overflow-hidden">
        ...
        {/* Desktop */}
        <div className="flex flex-col items-center gap-4">
          <div className="w-80 h-56 border-[4px] border-white/20 rounded-xl bg-[#0d1418] relative overflow-hidden group hover:border-[#E34A53]/50 transition-colors">
             <div className="absolute inset-x-2 top-2 bottom-2 border border-white/10 rounded overflow-hidden flex flex-row">
                <div className="w-16 border-r border-white/10 bg-[#162127]"></div>
