...
export default function Performance() {
  return (
    <section className="py-16 my-12 border-y border-black/10 relative bg-transparent backdrop-blur-sm">
      <div className="max-w-4xl mx-auto text-center mb-12 px-6">
        ...
        <p className="text-[#1c1c1b]/70 font-light">
      ...
      <div className="flex flex-wrap justify-center gap-4 max-w-5xl mx-auto px-6">
        {metrics.map((metric, i) => (
          <motion.div
            ...
            className="bg-white border border-[#E34A53]/30 px-6 py-5 rounded-xl flex flex-col items-center text-center shadow-[0_0_15px_rgba(227,74,83,0.1)] hover:shadow-[0_0_25px_rgba(227,74,83,0.2)] transition-shadow duration-300 flex-1 min-w-[200px]"
          >
            <span className="font-mono text-sm text-[#E34A53] mb-2 font-bold leading-tight">{metric.label}</span>
            <span className="text-[10px] text-[#1c1c1b]/60 uppercase tracking-wider">{metric.desc}</span>
          </motion.div>
        ))}
      </div>
    </section>
