...
export default function Accessibility() {
  ...
  return (
    <section className="py-12 my-12 bg-black/5 border border-black/10 rounded-2xl p-8 md:p-12 relative overflow-hidden shadow-xl">
      {/* Background pattern */}
      ...
      <p className="text-[#1c1c1b]/70 mb-8 max-w-2xl font-light relative z-10">Creative tools shouldn't exclude users. RetroLab is built with inclusive design patterns from day one.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 relative z-10">
        {items.map((item, i) => (
          ...
          >
            ...
            <span className="font-mono text-sm text-[#1c1c1b]">{item}</span>
          </motion.div>
        ))}
      </div>
    </section>
