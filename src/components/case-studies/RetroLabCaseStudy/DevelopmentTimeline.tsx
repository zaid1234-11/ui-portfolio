  ...
  return (
    <section className="py-12">
      ...
      <div className="relative">
        <div className="absolute top-4 left-4 right-4 h-0.5 bg-black/10 hidden md:block"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-6 relative z-10">
          {weeks.map((week, i) => (
            ...
            >
              <div className="w-8 h-8 rounded-full bg-transparent border-2 border-[#E34A53] flex items-center justify-center mb-4 z-10 shrink-0">
              ...
              <div className="text-left md:text-center">
                ...
                <h4 className="font-mono text-[10px] text-[#1c1c1b] uppercase tracking-widest mb-2 leading-tight">{week.title}</h4>
                <p className="text-[10px] text-[#1c1c1b]/50 font-light leading-relaxed">{week.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
